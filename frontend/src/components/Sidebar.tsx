          ...
          <div className="space-y-1">
            {RECENT_NOTES.map((note) => (
              <NavLink
                key={note.id}
                to={`/notes/${note.id}`}
                className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors truncate"
              >
